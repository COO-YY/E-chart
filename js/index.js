...
//         data: [70, 34, 60, 78, 69, 70, 34, 60, 78, 69, 70, 34, 60, 78, 40],
//         inverse: true,
...
//         roseType: "radius",
//         data: [
//           { value: 74.3, name: "离家近,方便快捷" },
//           { value: 60.2, name: "专业服务好" },
//           { value: 54.2, name: "环境整洁舒适" },
//           { value: 18.2, name: "性价比" },
//           { value: 17, name: "用户口碑" },
//           { value: 14.2, name: "可以提前预约咨询" },
//           { value: 4.9, name: "提供上门服务" },
//           { value: 3.1, name: "连锁机构" },
//           { value: 2.6, name: "品牌知名度" },
//         ],
//         // 图形文字
//         label: {
//           fontSize: 10,
